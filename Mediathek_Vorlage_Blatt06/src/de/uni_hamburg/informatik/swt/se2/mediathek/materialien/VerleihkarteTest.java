...
public class VerleihkarteTest
{
	...
	public void testegetFormatiertenString() throws Exception
	{
		...
		assertEquals(_medium.getFormatiertenString() + "am " + _datum.toString() + " verliehen an\n"
				+ _kunde.getFormatiertenString(), _karte.getFormatiertenString());
	}
